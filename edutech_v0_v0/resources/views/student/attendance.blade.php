    ...
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-400 mt-1">{{ $student->class->name }} - {{ $student->class->school->name }}</p>
            </div>
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden">
            ...
            @if($attendanceRecords->isEmpty())
                <div class="p-12 text-center">
                    ...
                    <p class="text-gray-400">Your attendance will appear here once marked by your teacher</p>
                </div>
            @else
