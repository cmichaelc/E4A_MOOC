...
<head>
    ...
    <title>Registration Successful - EduTech Benin</title>
        ...
        <div class="max-w-2xl w-full">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <p class="text-gray-300">
                                        <strong class="text-white">Start Using EduTech:</strong> After approval, log in
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-400 text-sm">
                    ...
                    <a href="mailto:support@edutech.bj" class="text-blue-400 hover:text-blue-300 underline">
                        support@edutech.bj
                    </a>
                </p>
            </div>
