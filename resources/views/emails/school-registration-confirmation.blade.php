...
<body>
    <div class="container">
        <div class="header">
            <h1>Welcome to E4A_MOOC Benin!</h1>
        </div>

        <div class="content">
            <h2>Dear {{ $manager->name }},</h2>

            <p>Thank you for registering <strong>{{ $school->name }}</strong> with E4A_MOOC Benin!</p>
            ...
            <p style="margin-top: 20px; font-size: 14px; color: #666;">
                If you have any questions, please contact our support team at support@E4A_MOOC.bj
            </p>
        </div>
