...
E4A_MOOC Benin is a comprehensive school management system built with Laravel 12, designed specifically for schools in Benin. It provides complete functionality for managing student records, attendance tracking, grade management, parent-teacher communication, and school administration.
...
MAIL_FROM_ADDRESS=noreply@E4A_MOOC.bj
MAIL_FROM_NAME="E4A_MOOC Benin"
```
...
Proprietary software - E4A_MOOC Benin
