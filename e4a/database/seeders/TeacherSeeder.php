...
class TeacherSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Create 5 teachers
        $teacherData = [
            ['name' => 'Robert Dossou', 'email' => 'teacher1@edutech.bj', 'specialization' => 'Mathematics'],
            ['name' => 'Sophie Ahouandjinou', 'email' => 'teacher2@edutech.bj', 'specialization' => 'Languages'],
            ['name' => 'Paul Akplogan', 'email' => 'teacher3@edutech.bj', 'specialization' => 'Sciences'],
            ['name' => 'Claudine Zannou', 'email' => 'teacher4@edutech.bj', 'specialization' => 'History'],
            ['name' => 'Jacques Hounkanrin', 'email' => 'teacher5@edutech.bj', 'specialization' => 'General'],
        ];
